...
import { WidgetMyPlants } from '../../composant/Share/Page-Aide/widget-my-plants/widget-my-plants';
...
@Component({
  ...
  styleUrls: ['./my-plants.css'],
})
export class MyPlants implements OnInit {
  ...
  ngOnInit(): void {
    // 🧠 Titre de la page
    this.titleService.setTitle('JardiScan | Aide Plantes');
