...
import { WidgetParamettre } from '../../composant/Share/Page-Paramettre/widget-paramettre/widget-paramettre';
...
export class Paramettre implements OnInit {
  ...
  ngOnInit(): void {
    // 🧠 Titre de la page
    this.titleService.setTitle('JardiScan | Paramètres');
